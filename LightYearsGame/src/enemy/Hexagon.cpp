...
namespace ly {
Hexagon::Hexagon(World *owingWorld, const std::string &texturePath,
    ...
    : EnemySpaceship{owingWorld, texturePath},
      ...
      mShooter4{
          new BulletShooter{this, 1.f, sf::Vector2f{-50.f, 0.0f}, -180.f}},
      mShooter5{
          new BulletShooter{this, 1.f, sf::Vector2f{-20.f, 50.0f}, 120.f}},
      mShooter6{
          new BulletShooter{this, 1.f, sf::Vector2f{-20.f, -50.0f}, -120.f}} {
